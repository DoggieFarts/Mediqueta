...
<script src="https://kit.fontawesome.com/915d84c88d.js" crossorigin="anonymous"></script>
    ...
    <link rel="stylesheet" type="text/css" href="elmed.css">
    ...
    <div class="row">
      <div class="col s3 card-panel hide-on-med-and-down" id="panelchiquito" data-aos="fade-up">
       ...
       <span class="datos1"> Hola <?php echo $_SESSION['user'];?>
          ...
          <br>
          <br>
          <span class="datos2">Estos son todos tus medicamentos al dia de hoy. Para eliminar el medicamento escribe en el espacio disponible su nombre. Una vez eliminado recarga la página para ver los cambios realizados. </span>
 ...
 $sql = "SELECT email, cliente_color.id_med, medicamento.* FROM cliente_color RIGHT JOIN medicamento ON cliente_color.id_med = medicamento.id_med WHERE email=?";
          ...
          ";
                    ...
                    if($_SERVER["REQUEST_METHOD"] == "POST"){
                     $sql = "DELETE FROM cliente_color WHERE id_med IN (SELECT  id_med FROM medicamento WHERE (nombre_med = '".$_POST['nombremed']."' ) AND email= '".$_SESSION['email']."' );
";
                      $res = mysqli_query($enlace, $sql) or die ("ERROR al ejecutar :"); 
            ...
            <form class="col s12 " method="post" action="#" autocomplete="off" id="forma">
                <div class="row">
        <div class="input-field col s12">
          <i class="material-icons prefix">assignment_ind</i>
          <input id="nombremed" type="text" class="validate" name="nombremed">
          <label for="nombremed">Nombre del Medicamento a eliminar</label>
        </div>
                    <button class="btn waves-effect waves-purple purple darken-3 right" type="submit" name="action">Eliminar
